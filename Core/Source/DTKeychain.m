...
- (BOOL)retrieveSecuredDataForKeychainItem:(DTKeychainItem *)keychainItem error:(NSError *__autoreleasing *)error
{
	...
	{
		keychainItem.secureData = (__bridge_transfer NSData *)result;
...
#if TARGET_OS_IPHONE
	// on iPhone we can get the password as well, on Mac this requires extra permission for each individual item
